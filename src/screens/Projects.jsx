...
const Projects = () => {
    return (
        <div className='projects'>
            <div className='projectContainer'><a href='http://markbdesigns.com/' target='blank' rel="noopener noreferrer"><img src={mark} alt='ornate' className='ornate' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://markbdesigns.com/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>
            <div className='projectContainer'><a href='http://konetink.surge.sh/' target='blank' rel="noopener noreferrer"><img src={konetink} alt='ornate' className='ornate' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://konetink.surge.sh/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>
            <div className='projectContainer'><a href='http://eatzilla.surge.sh/' target='blank' rel="noopener noreferrer"><img src={eatzilla} alt='eatzilla' className='eatzilla' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://eatzilla.surge.sh/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>
            <div className='projectContainer'><a href='http://camelot-experience.surge.sh/' target='blank' rel="noopener noreferrer"><img src={camelot} alt='camelot' className='camelot' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://camelot-experience.surge.sh/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>

            <div className='projectContainer'><a href='http://ornate-optical.surge.sh/' target='blank' rel="noopener noreferrer"><img src={ornate} alt='ornate' className='ornate' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://ornate-optical.surge.sh/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>

            <div className='projectContainer'><a href='http://trip-to-stars.surge.sh/' target='blank' rel="noopener noreferrer"><img src={stars} alt='stars' className='stars' /></a>
                <div className='projBottom'>
                    ...
                    <a href='http://trip-to-stars.surge.sh/' target='blank' rel="noopener noreferrer"><img src={computerIcon} className='compIcon' alt='compIcon' /></a></div>
            </div>
